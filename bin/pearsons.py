...
dialog = wx.FileDialog(None, "Choose a data file to calculate Pearson's correlation coefficient", os.getcwd(), "","*.dat", wx.FD_OPEN)
if dialog.ShowModal() == wx.ID_OK:
    ...
    if columns == 2 and rows > 4:
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            res=open(res_file,'w')
            res.write("\n\nPearsons correlation statistics on "+str(base)+"\n\n")
